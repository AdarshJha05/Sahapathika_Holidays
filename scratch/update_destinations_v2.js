...
const destGroupsOldRegex = /destGroups: \[\s*\{\s*title: 'KERALA'[\s\S]*?items: \['Middle East', 'South-East Asia', 'Europe', 'Sri Lanka', 'Maldives', 'Far East'\]\.map\(n => \(\{ name: n, initial: n\[0\], photo: '' \}\)\)\s*\}\s*\]/m;
